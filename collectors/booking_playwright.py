    ...
    def collect(
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                step(0.45, "collecting bounded Booking network batches", visible_card_count=card_count_before)
                ...
                self.log(log_callback, f"Bounded network batches retained {final_count} final records.")
