...
def _result_csv_row(row: dict[str, Any], *, session_id: Any, instance_id: str, exported_at: datetime) -> dict[str, Any]:
    ...
    payload.update({
        ...
        "requested_checkin_date": _serialize_for_csv(row.get("requested_checkin_date")),
        "requested_checkout_date": _serialize_for_csv(row.get("requested_checkout_date")),
        "effective_checkin_date": _serialize_for_csv(row.get("effective_checkin_date")),
        "effective_checkout_date": _serialize_for_csv(row.get("effective_checkout_date")),
        "date_integrity_verified": _serialize_for_csv(row.get("date_integrity_verified")),
        "property_type": _serialize_for_csv(row.get("property_type")),
