...
def _network_property(result: dict[str, Any]) -> dict[str, Any] | None:
    ...
    room_name = _display_text(_first_path(result, (
        ...
        ("blocks", "0", "roomDetails", "0", "name"),
        ("matchingUnits", "0", "unitName"),
    )))
    taxes_and_fees = _display_text(_first_path(result, (
        ("priceDisplayInfoIrene", "excludedCharges"),
        ("priceDisplayInfoIrene", "taxesAndCharges"),
        ("priceDisplayInfoIrene", "displayPrice", "excludedCharges"),
    )))
    return {
